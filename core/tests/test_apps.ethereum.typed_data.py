...
class TestEthereumSignTypedData(unittest.TestCase):
    def test_hash_struct(self):
        ...
        VECTORS = (  # primary_type, data, types, expected
            ...
            (
                ...
                MESSAGE_VALUES_LIST,
                TYPES_LIST,
                b"O&\x99\xcd'4\x81\xde\xda\nOs+\xb3d\xc8'\xeb^#\xf0\x8c\x9f!\xcd\xec\x0e\xdfSF\x11K",
            ),
        )
    ...
    def test_encode_data(self):
        VECTORS = (  # primary_type, data, types, expected
            ...
            (
                ...
                MESSAGE_VALUES_LIST,
                TYPES_LIST,
                b"s\xe6\x01\x83\xf0X55!\x81\x15\xd99\x8c\x9cQ\xaeX\xa0\xc3\x04\x05\x16\x84\xf3N\x9bq\xb08\xe2\xd4\x1c\x16\xcc\x17Q\xf5\xac\xc9\xd3\x03\xb3\x9cl\x1a7\x9ey\xae\x0fn\x81\x9d\xc6X\x80\x10\xdd\xab I'\x88.\xf5\xf3=3t\xf4\xb6%\xfd\x1bu\xba\xae\xb1\xfa\xbd\xa5%\x8a\xc2\xa3\x19\x0bbu\xf2\xadzkg\x93",
            ),
        )
        for primary_type, data, types, expected in VECTORS:
            w = bytearray()
    ...
    def test_encode_field(self):
        ...
        w_not_in_array = bytearray()
        w_in_array = bytearray()
        encode_field(
            w=w_not_in_array,
            field=field,
            value=value,
        ...
        self.assertEqual(w_not_in_array, expected_not_in_array)
        self.assertEqual(w_in_array, expected_in_array)
